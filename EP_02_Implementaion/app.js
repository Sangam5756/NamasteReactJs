...
const RestaurentCard = ({resData}) => (
  ...
  <div className="res-card">
    {console.log(resData)}
    {console.log(resData[0].card.card.info)}
    <img
      className="res-logo"
      src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/8ce19b0d185a8c0ffc0725d64cc262f3"
      alt="foodlogo"
    />
    <h3>{resData[0].card.card.info.name}</h3>
    <h4>Desi Khana,Homemade food</h4>
    <h4>{resData[0].card.card.info.avgRatingString}</h4>
    <h4>38 mins</h4>
  </div>
);
...
const Body = () => 
  ...
  <div className="body">
    ...
    <div className="res-container">
      <RestaurentCard resData={api_Data} />
    </div>
  </div>
);
